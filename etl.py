...
# Build SparkSession
spark = SparkSession.builder.master("local[*]").appName("ETL_Pipeline").getOrCreate()

# Set Loggin Level to WARN
spark.sparkContext.setLogLevel("WARN")


########### EXTRACT ##########

# Clean data stored in data/*
source_data_file = "data/*"

# Define CSV inputs schema
schema = StructType([
...
print("Data points from files counts: {}".format(count))
...
print("Data point after adding month, year, and day: {}".format(df_with_month_year_count))
